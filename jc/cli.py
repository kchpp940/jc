...
from .lib import (
    __version__, jc_info, parsers, get_parser, _parser_is_streaming,
...
class JcCli():
    ...
    def parser_categories_text(self) -> str:
        ...
        category_text: str = ''
        padding_char: str = ' '
        categories = parser_categories(show_hidden=True, show_deprecated=False)
    ...
    def help_doc(self) -> None:
        ...
        for arg in self.args:
            ...
            if parser_name in parsers:
                ...
                footer: str = parser_doc_footer(p_info)
    ...
    def magic_parser(self) -> None:
        ...
        magic_dict = magic_commands_dict()
